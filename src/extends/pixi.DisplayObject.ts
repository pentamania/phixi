 ...
 * @returns this
 */
addMethod(DisplayObject.prototype, "attach", function (
  accessory: phina.accessory.Accessory
) {
  if (!this.accessories) {
    this.accessories = [];
 ...
 * @returns this
 */
addMethod(DisplayObject.prototype, "detach", function (
  accessory: phina.accessory.Accessory
) {
  if (this.accessories) {
 ...
 */
addMethod(DisplayObject.prototype, "setPosition", function (
  x: number = 0,
  y: number = 0
) {
